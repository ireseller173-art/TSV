...
## Phase 26: Завершение недореализованных функций на 100%

### Групповые чаты - Расширенные функции (90% → 100%)
- [ ] Расширенные права администратора (назначение модератора)
- [ ] Ограничение прав членов группы
- [ ] Архивирование групп
- [ ] Экспорт истории группы

### Шифрование (60% → 100%)
- [ ] End-to-end encryption (E2EE) с использованием TweetNaCl.js
- [ ] Perfect forward secrecy
- [ ] Key rotation mechanism
- [ ] Secure key exchange

### Профиль пользователя (85% → 100%)
- [ ] Avatar cropping компонент
- [ ] Интеграция avatar cropping в profile-edit
- [ ] Галерея фото пользователя
- [ ] Статус "в сети" с точным временем

### Истории (Stories) (10% → 100%)
- [ ] UI для просмотра историй
- [ ] Создание историй
- [ ] 24-часовой таймер для историй
- [ ] Удаление истории по истечении 24 часов

### Уведомления (95% → 100%)
- [ ] Полная интеграция notification preferences UI
- [ ] Категории уведомлений (по типам)
- [ ] Управление уведомлениями по типам

### Поиск (70% → 100%)
- [ ] Глобальный поиск по всем сообщениям и контактам
- [ ] Сохранённые поиски
- [ ] История поисков
- [ ] Быстрые фильтры поиска
